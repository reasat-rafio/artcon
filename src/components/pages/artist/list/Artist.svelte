...
<IntersectionObserver element={sectionEl} bind:intersecting threshold={0.4}>
  <div
    ...
    <a
      ...
      class="relative flex flex-col md:pr-[2rem] lg:mt-[3.13rem] 2xl:pr-[5.81rem]">
      ...
      {#if !!artworks?.length}
        {#each artworks as { artworkImage, name, slug }}
          <a
            ...
            class="relative self-start rounded-[0.75rem] md:pb-[3rem] md:pl-[1.5rem] md:pr-[1.5rem] md:pt-[1.5rem] xl:pb-[3rem] xl:pl-[2.5rem] xl:pr-[2.5rem] xl:pt-[2.5rem] 2xl:pb-[4.09rem] 2xl:pl-[3.37rem] 2xl:pr-[3.39rem] 2xl:pt-[3.35rem]">
            <figure>
              <SanityImage
